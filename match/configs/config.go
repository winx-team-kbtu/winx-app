...
type (
	...
	kafkaTopics struct {
		SwipeLeft    string `yaml:"swipe_left"`
		SwipeRight   string `yaml:"swipe_right"`
...
func InitConfig() {
	...
	Config = &config{
		...
		Kafka: kafka{
			...
			Topics: kafkaTopics{
				SwipeLeft:    viper.GetString("kafka.topics.swipe_left"),
				SwipeRight:   viper.GetString("kafka.topics.swipe_right"),
